...
class Beneficiary(Base):
    ...
    husband_contact_no = Column(String(15))
    dob = Column(Date)
    address = Column(Text)
    village = Column(Text)
    phc = Column(Text)
    ...
    other_family_member_name = Column(Text)
    other_family_member_relation = Column(String(50))
    family_contact_no = Column(String(15))
